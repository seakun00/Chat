...
export const Comments = () => {
    ...
    const [scrollPosition, setScrollPosition] = useState<HTMLLIElement|null>(null);
    useEffect(() => {
        scrollPosition
    ...
    const handleScroll = (event: UIEvent<HTMLUListElement>) => {
        ...
        if (isTop) {
            ...
            commentList.current && setScrollPosition(commentList.current.firstElementChild as HTMLLIElement)
